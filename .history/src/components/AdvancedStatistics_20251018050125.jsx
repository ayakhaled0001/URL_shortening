function AdvancedStatistics() {
  return (
    <section className="font-poppins pt-16 md:pt-20 lg:pt-25 py-12 md:py-15 bg-gray-100">
      ...
      <div className="flex flex-col xl:flex-row xl:flex-wrap justify-center items-center xl:items-stretch gap-6 md:gap-8 xl:gap-10 my-8 px-4">
        <div className="w-full max-w-sm md:max-w-md xl:w-90 bg-white rounded-md px-6 pt-15 pb-8 relative z-10 mx-auto">
        ...
        <div className="w-full z-10 max-w-sm md:max-w-md xl:w-90 translate-y-0 xl:translate-y-10 bg-white rounded-md px-6 pt-15 pb-8 relative mx-auto">
          <div className="absolute -top-9 left-1/2 transform -translate-x-1/2 md:left-6 md:transform-none inline-block bg-Purple-950 p-4 rounded-full">
        ...
        <div className="w-full z-10 max-w-sm md:max-w-md xl:w-90 translate-y-0 xl:translate-y-14 bg-white rounded-md px-6 pt-15 pb-8 relative mx-auto">
          <div className="absolute -top-9 left-1/2 transform -translate-x-1/2 md:left-6 md:transform-none inline-block bg-Purple-950 p-4 rounded-full">
