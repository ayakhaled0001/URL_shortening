  ...
  return (
    <section className="font-poppins pt-16 md:pt-20 lg:pt-25 py-12 md:py-15 bg-gray-100">
      ...
      <div className="flex flex-col lg:flex-row justify-center gap-6 md:gap-8 lg:gap-10 my-8 px-4">
        ...
        <div className="hidden lg:block before:content-[''] after:content-[''] before:h-2 after:h-2 before:w-12 after:w-12 before:bg-Blue-400 after:bg-Blue-400 before:absolute after:absolute before:-left-12 after:-right-12 before:-z-10 after:-z-10 after:top-16"></div>
